    ...
    <div className="flex items-center justify-center h-screen bg-blue-500">
      <div className="bg-white  flex flex-col items-center p-10 rounded-lg drop-shadow-md w-96">
        ...
        <form method="post" action="/api/auth/signin/facebook" className="w-full">
          ...
          <button type="submit" className="flex items-center justify-center   py-2 w-full rounded-md gap-2 bg-blue-100 text-blue-500">
        ...
        <form method="post" action="/api/auth/signin/google" className="w-full">
          ...
          <button type="submit" className="flex items-center justify-center   py-2 w-full rounded-md mt-5 gap-2 bg-blue-100 text-blue-500">
