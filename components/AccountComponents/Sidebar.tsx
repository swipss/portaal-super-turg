...
export const Sidebar = () => {
  ...
  function useOutsideAlerter(drawerRef) {
    useEffect(() => {
      /**
  ...
  return (
    ...
    //           </svg>
    //           <span className="flex-1 ml-3 whitespace-nowrap">Küsimused</span>
    //           <span className="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-200">
    //             3
    //           </span>
    //         </a>
    ...
    //             ></path>
    //           </svg>
    //           <span className="flex-1 ml-3 whitespace-nowrap">Suhtlus</span>
    //         </a>
    //       </li>
    //       <li>
    //         <a
    ...
    //             ></path>
    //           </svg>
    //           <span className="flex-1 ml-3 whitespace-nowrap">Teated</span>
    //         </a>
    //       </li>
    //       <li>
    //         <a
    ...
    //             ></path>
    //           </svg>
    //           <span className="flex-1 ml-3 whitespace-nowrap">Lemmikud</span>
    //         </a>
    //       </li>
    //     </ul>
    ...
    //             ></path>
    //           </svg>
    //           <span className="ml-4">Vaatasin</span>
    //         </a>
    //       </li>
    //       <li>
    ...
    //               ></path>
    //             </svg>
    //             <span className="ml-3">Andmed</span>
    //           </a>
    //         </Link>
    //       </li>
    //       {/* <li>
                ...
                <li>
                  <Link href={'/account/kuulutused'}>
                    ...
                    >
                      ...
                      <span className="ml-3">Kuulutused</span>
                    </a>
                  </Link>
                </li>
                <li>
