  ...
  return (
    <>
      <div className="text-center">
        {!open && (
          <button
            className="text-white fixed top-16 m-2 shadow-md z-10 left-0  bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  p-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            type="button"
