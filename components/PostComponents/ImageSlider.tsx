      ...
      <div className=" p-4 flex items-center justify-center ">
        <div className="relative w-full flex items-center justify-center">
          <FontAwesomeIcon
            ...
            icon={faArrowRight}
            className="absolute right-0 text-5xl text-gray-300 cursor-pointer hover:transform hover:-translate-y-2 hover:ease-in-out duration-100 hover:text-black"
          />
          <FontAwesomeIcon
            onClick={() => handleImageChangeForward()}
            icon={faArrowLeft}
            className="absolute left-0 text-5xl text-gray-300 cursor-pointer hover:-translate-y-2 hover:ease-in-out duration-100 hover:text-black"
          />

          <img
            src={selectedImage?.secureUrl}
            className="cursor-pointer h-96 object-cover object-center"
          ...
          <div className="w-screen h-full absolute inset-0">
            ...
            <div>
              ...
              <img
                onClick={() => setIsFullscreen(!isFullscreen)}
                src={selectedImage?.secureUrl}
                className={`cursor-pointer sm:h-screen m-auto absolute object-cover object-center inset-0 opacity-100 z-20 `}
              />
              {images?.length > 1 && (
                <FontAwesomeIcon
                  icon={faArrowLeft}
